...
const mockData = {
  subscriptions: [
    { id: 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', name: 'Production', state: 'Enabled' },
  ...
  ipAddresses: [
    {
      id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/networkInterfaces/nic-web-01/ipConfigurations/ipconfig1',
      ipAddress: '10.0.1.4',
    ...
    {
      id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/networkInterfaces/nic-web-02/ipConfigurations/ipconfig1',
      ipAddress: '10.0.1.5',
      type: 'Private' as const,
    ...
    {
      id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/networkInterfaces/nic-app-01/ipConfigurations/ipconfig1',
      ipAddress: '10.0.2.10',
      type: 'Private' as const,
      allocationMethod: 'Static' as const,
      resourceGroup: 'rg-prod',
    ...
    {
      id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/publicIPAddresses/pip-bastion',
    ...
    {
      id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/publicIPAddresses/pip-appgw',
  ...
  subnets: [
    {
      id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod/subnets/subnet-web',
      name: 'subnet-web',
      vnetId: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod',
      vnetName: 'vnet-prod',
      resourceGroup: 'rg-prod',
      subscriptionId: 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee',
      subscriptionName: 'Production',
    ...
    {
      id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod/subnets/subnet-app',
      name: 'subnet-app',
      vnetId: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod',
      vnetName: 'vnet-prod',
      resourceGroup: 'rg-prod',
    ...
    {
      id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod/subnets/subnet-db',
      name: 'subnet-db',
      vnetId: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod',
      vnetName: 'vnet-prod',
      resourceGroup: 'rg-prod',
    ...
    {
      id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod/subnets/GatewaySubnet',
      name: 'GatewaySubnet',
      vnetId: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod',
      vnetName: 'vnet-prod',
      resourceGroup: 'rg-prod',
  ...
  conflicts: [
    {
      ...
      resources: [
        {
          id: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod-eastus',
  ...
  events: [
    {
      ...
      resourceId: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod/subnets/subnet-new',
    ...
    },
    {
      ...
      resourceId: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/publicIPAddresses/pip-loadbalancer-frontend',
    ...
    },
    {
      ...
      resourceId: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-prod/providers/Microsoft.Network/virtualNetworks/vnet-prod/subnets/subnet-web',
    ...
    },
    {
      ...
      resourceId: '/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg-dr/providers/Microsoft.Network/virtualNetworks/vnet-dr-westus2',
